...
export default function RegisterPage() {
  return (
    <div className="min-h-screen lg:h-screen w-full grid grid-cols-1 lg:grid-cols-2 bg-[#F8FAFC] lg:overflow-hidden">
      {/* Left: Illustration — hidden on phones, shown from tablet landscape (lg) up */}
      <div className="hidden lg:block relative h-full">
        ...
        <motion.div
          ...
          className="absolute top-10 right-10 bg-white/20 backdrop-blur-md rounded-2xl p-2.5 border border-white/30"
        >
        ...
        <motion.div
          ...
          className="absolute bottom-24 left-8 bg-white/20 backdrop-blur-md rounded-2xl p-2.5 border border-white/30"
        >
        ...
        <motion.div
          ...
          className="absolute top-1/3 left-6 bg-white/20 backdrop-blur-md rounded-2xl p-2.5 border border-white/30"
        >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-center bg-gradient-to-t from-black/40 to-transparent">
          ...
          <p className="text-white/90 text-xs mt-1.5 max-w-sm mx-auto">
            Join our intelligent hostel management platform for a smarter and safer campus living
            experience.
          </p>
        </div>
      </div>
